...
class AppDelegate: UIResponder, UIApplicationDelegate {
  ...
  func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
    ...
    let rootView:RCTRootView = RCTRootView(bundleURL: jsCodeLocation, moduleName: "RCTUnderdark", initialProperties: nil, launchOptions: launchOptions)
  ...
  lazy var managedObjectModel: NSManagedObjectModel = {
    ...
    let modelURL = Bundle.main.url(forResource: "RCTUnderDark", withExtension: "momd")!
